...
//         <Form.Field>
//           <label> Name</label>
//           <input placeholder="Item Name" type="text" value={name} onChange={e => setName(e.target.value)} />
//         </Form.Field>
...
//             update={(store, { data: { updateFoodItem } }) => props.updateFoodItem(store, updateFoodItem)}
//           >
...
//             onCompleted={props.toggle}
//             update={(store, { data: { createFoodItem } }) => props.addFoodItem(store, createFoodItem)}
//           >
//             {createFoodItemMutation => (
//               <Button
//                 type="submit"
