...
render(){
    return(
            ...
            <Form>
                ...
                <Form.Field>
                <label>Mobile</label>
                <input name= 'mobile' placeholder='Mobile' type='number' value={this.state.mobile} onChange={this.handleChange}/>
                </Form.Field>
                <Form.Field>
                <label>Default chapati</label>
                <input name= 'defaultChapati' placeholder='count' type='number' value={this.state.defaultChapati} onChange={this.handleChange} />
                </Form.Field>
